...
// Métodos Especiais (construtor):
	...
	public Venda(String dataVenda, String formaPagamento, Float valorTotal, boolean vendaOnline, Vendedor vendedor,
		Cliente cliente, Produto brinquedos, LocalRetirada localRetirada) {
...
// Métodos Acessores: 
	...
	public Produto getBrinquedos() {
		return brinquedos;
	}

	public void setBrinquedos(Produto brinquedos) {
		this.brinquedos = brinquedos;
	}
